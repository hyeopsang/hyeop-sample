...
const apiRequest = (method: string, url: string, options: AxiosRequestConfig = {}) => {
...
export const updatePost = (id: string, data: UpdatePostDTO, options?: AxiosRequestConfig) =>
...
export const createComment = (id: string, data: CreateCommentDTO, options?: AxiosRequestConfig) =>
