...
import { CreateComment } from "@/app/write-form/_components/_action/createComments";
...
export default function CommentWriteForm({ postId }: Props) {
    ...
    return (
        <form action={handleSubmit} className='w-full pt-4 flex flex-wrap justify-end gap-1'>
